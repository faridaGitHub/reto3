...
public class Billete extends JFrame {
	...
	private JComboBox<Paradas> comboBoxOrigen;
	...
	public Billete() {
		...
		//comboBoxOrigen.setModel(new DefaultComboBoxModel(new String[] {"BILBAO", "MUNGIA", "GERNIKA", "DONOSTIA"}));
		comboBoxOrigen.setBounds(76, 115, 79, 22);
		panel.add(comboBoxOrigen);
		
		this.comboBoxDestino = new JComboBox();
		//comboBoxDestino.setModel(new DefaultComboBoxModel(new String[] {"BILBAO", "MUNGIA", "GERNIKA", "DONOSTIA"}));
		comboBoxDestino.setBounds(307, 115, 79, 22);
